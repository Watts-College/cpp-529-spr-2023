...
This lab will have you replicate the work you did for the previous lab, but instead of using the Phoenix data you will select San Diego as your city of  choice to use for this lab, subsequent labs, and the final project. 
